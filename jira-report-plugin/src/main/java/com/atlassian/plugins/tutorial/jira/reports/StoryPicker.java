...
public class StoryPicker implements ValuesGenerator {
    @ComponentImport
    private SearchService searchService;
    @ComponentImport
    private JiraAuthenticationContext authenticationContext;

    private static final String STORY_CONSTANT = "1";
    private static final String ALL_SELECT = "2";
    private static final String NONE_SELECT = "3";

    @Inject
    public StoryPicker(SearchService searchService, JiraAuthenticationContext authenticationContext) {
    ...
    public Map getValues(Map userParams) {
        ...
        try {
            ...
            for(Issue issue : issues){
                ...
                if(issueType.getName().contains("Story")) {
        ...
        if(result.size() < 2){
            result.clear();
            result.put(STORY_CONSTANT,"No Stories Available");
        }
