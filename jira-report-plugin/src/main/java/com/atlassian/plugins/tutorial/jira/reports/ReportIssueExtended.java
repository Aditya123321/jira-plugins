...
public class ReportIssueExtended {
    ...
    private static List transformSubTasks(Issue issue, final AggregateTimeTrackingCalculator aggregateCalculator, final DurationFormatterExtended durationFormatter, final AccuracyCalculatorExtended accuracyCalculator, Comparator comparator, Predicate issueInclusionPredicate) {
        ...
        CollectionUtils.transform(reportIssueSubTasks, new Transformer() {
            public Object transform(Object object) {
                ...
                return new ReportIssueExtended(issue, aggregateCalculator.getAggregates(issue), durationFormatter, accuracyCalculator, new ArrayList(), false);
            }
        });
    ...
    private ReportIssueExtended(Issue issue, AggregateTimeTrackingBean aggregateBean, final DurationFormatterExtended durationFormatter, final AccuracyCalculatorExtended accuracyCalculator, List subTasks, boolean isOrphan) {
        this.issue = issue;
    ...
    public ReportIssueExtended(Issue issue, AggregateTimeTrackingCalculator aggregateCalculator, final DurationFormatterExtended durationFormatter, final AccuracyCalculatorExtended accuracyCalculator, Comparator comparator, Predicate issueInclusionPredicate) {
